...
\begin{figure}
	\centering
	\input{graphics/plots/rapp_isl_tutti_tratti}
...
\begin{figure}
	\centering
	\input{graphics/plots/rapp_isl_2008_2016}
...
\begin{figure}
	\centering
	\input{graphics/plots/rapp_isl_vs_letteratura}
...
\squarecite{Surian:2015} ha considerato come isole solamente le piante che crescono in alveo, senza tenere conto delle zone parzialmente vegetate o poco vegetate che possono esservi all'interno (si veda la \cref{fig:esempio-isola}), ed ha escluso le piante “intermedie” e “alte” dall'areale dell'alveo attivo;
