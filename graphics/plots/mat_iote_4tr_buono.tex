...
%		xlabel = {Int livelli \si{[\m\giorno]}},
		...
		title = {TR \SIrange[range-phrase={-}, range-units=single]{2}{3}{\mesi}},
			...
			\node at (axis description cs: 1,0) [draw = black, fill = white, anchor = south east] {$R^2 = 0.69$};
...
%		xlabel = {Int livelli \si{[\m\giorno]}},
		...
		title = {TR \SIrange[range-phrase={-}, range-units=single]{2}{3}{\mesi}},
			...
			\node at (axis description cs: 1,0) [draw = black, fill = white, anchor = south east] {$R^2 = 0.56$};
	...
	\nextgroupplot[ % gruppo 1 livello 2.4
		...
		title = {TR \SI{\sim 1}{\anno}},
			...
			\node at (axis description cs: 1,0) [draw = black, fill = white, anchor = south east] {$R^2 = 0.54$};
