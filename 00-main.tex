...
\usepackage[bibstyle=authoryear,citestyle=authoryear-ibid-brack,backend=biber]{biblatex}	% per la bib
...
\newglossaryentry{es}{name={esempio},plural={esempi},description={un piccolo esempio}}
...
\input{capitoli/2-vegetazione-piene}
%----------------------------------------------------------
