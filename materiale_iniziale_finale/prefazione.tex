...
\begin{figure}[h]
	...
	\caption[foto di un tratto del Tagliamento ripreso dal monte di Flagogna]{foto di un tratto del Tagliamento ripreso dal monte di Flagogna~(UD); l'acqua scorre da destra verso sinistra. Foto dell'autore.
	}
...
\begin{figure}
	...
	\caption[immagini di un tratto posto circa \SI{2}{\kilo\m} a monte del ponte di Cornino]{immagini di un tratto posto circa \SI{2}{\kilo\m} a monte del ponte di Cornino~(UD).
	}
...
\begin{figure}[hb]
	...
	\caption[bagnanti accanto ad un canale]{bagnanti accanto ad un canale ripresi con una immagine area.}
	\label{fig:bagnanti}
\end{figure}
