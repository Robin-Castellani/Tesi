...
%
\begin{itemize}
	\item satellite Terra, sensore ASTER Livello~1T (ottenuti in data~21~luglio~2018 \brackcite{data:ASTER});  
		\\
...
% strumenti
\medskip
Per eseguire le analisi sulle immagini aeree e satellitari sono stati utilizzati i GIS GRASS \brackcite{soft:GRASS} e QGIS \brackcite{soft:QGIS}. 
Per il download e il pre-processing delle immagini satellitari è stato usato SCP, plugin di QGIS \brackcite{soft:SCP}. 
