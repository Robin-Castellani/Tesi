...
\begin{tikzpicture}
	...
	\nextgroupplot[ % tronchi fermi
		...
		\addplot [
		        boxplot prepared = {
		                lower whisker = -0.214108,
		                lower quartile = 0.234276,
		                median = 0.399475,
		                upper quartile = 0.459583,
		                upper whisker = 0.508607,
		                },
		        ]
		        coordinates {}
		...
		\addplot [
		        boxplot prepared = {
		                lower whisker = 0.006691,
		                lower quartile = 0.325199,
		                median = 0.411842,
		                upper quartile = 0.508083,
		                upper whisker = 0.563896,
		                },
		        ]
		        coordinates {}
		node[below, red!75!black] at (boxplot box cs: \boxplotvalue{lower whisker},0.5){\pgfmathprintnumber{16}};
		\addplot [
		        boxplot prepared = {
		                lower whisker = 0.012381,
		                lower quartile = 0.243774,
		                median = 0.393280,
		                upper quartile = 0.515945,
		                upper whisker = 0.584189,
		                },
		        ]
		        coordinates {}
		node[below, red!75!black] at (boxplot box cs: \boxplotvalue{lower whisker},0.5){\pgfmathprintnumber{25}};
		\addplot [
		        boxplot prepared = {
		                lower whisker = -0.025824,
		                lower quartile = 0.243774,
		                median = 0.393280,
		                upper quartile = 0.505463,
		                upper whisker = 0.571835,
		                },
		        ]
		        coordinates {}
		node[below, red!75!black] at (boxplot box cs: \boxplotvalue{lower whisker},0.5){\pgfmathprintnumber{29}};
	%------------------------------------------------------
	...
	\nextgroupplot[ % elementi spostati
		...
		\addplot [ % 400+ punti
		        boxplot prepared = {
		                lower whisker = -0.400027,
		                lower quartile = -0.152180,
		                median = 0.138489,
		                upper quartile = 0.345379,
