...
a tal fine si è seguito l'approccio di altri autori in analisi simili eseguite su immagini ASTER e LandSat~TM \brackcites{Bertoldi:2011-ASTER}{Henshaw:2013-LandSat}.
%
\begin{enumerate}
	...
	\end{figure}
	%
	\item Da tali grafici sono state ottenute delle soglie di NDVI per classificare le immagini satellitari (\vref{tab:ndvi-soglia}). Le soglie sono in accordo con quanto riportato in letteratura \brackcite{Bertoldi:2011-ASTER}.
	%
	\begin{table}[ht]
		\centering
		\begin{tabular}{
