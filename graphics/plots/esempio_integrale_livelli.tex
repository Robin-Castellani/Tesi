...
%		ymax = 3.5,
	...
	\nextgroupplot[
		...
		\node at (axis description cs: 0,1) [draw = black, fill = white, anchor = north west, align = left] {TR \SIrange[range-phrase={-}, range-units = single]{2}{3}{\mesi} \\ Livello \SI{1.5}{\m}};
	...
	\nextgroupplot[
		...
		\node at (axis description cs: 0,1) [draw = black, fill = white, anchor = north west, align = left] {TR \SIrange[range-phrase={-}, range-units = single]{4}{5}{\mesi} \\ Livello \SI{2}{\m}};
	...
	\nextgroupplot[
		...
		\addplot fill between [
			...
			every segment no 4/.style = {transparent},
			every segment no 5/.style = {transparent},
		];
		
		\node at (axis description cs: 0,1) [draw = black, fill = white, anchor = north west,] {$Int = \SI{0.90}{\m\giorno}$};
	...
	\nextgroupplot[
		...
		\addplot fill between [
			...
			every segment no 3/.style = {transparent},
			every segment no 4/.style = {transparent},
		];
		
		\node at (axis description cs: 0,1) [draw = black, fill = white, anchor = north west,] {$Int = \SI{0.12}{\m\giorno}$};
	\end{groupplot}
\end{tikzpicture}