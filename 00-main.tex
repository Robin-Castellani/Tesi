...
\input{materiale_iniziale_finale/colophon}

%----------------------------------------------------------
\tableofcontents
\listoffigures
\addcontentsline{toc}{chapter}{\tocEntry{Elenco delle figure}}
\listoftables
\addcontentsline{toc}{chapter}{\tocEntry{Elenco delle tabelle}}
%----------------------------------------------------------
\chapter{Prefazione}
...
\chapter{In quali condizioni e in quale misura le isole cambiano?}
...
\phantomsection
\addcontentsline{toc}{chapter}{\tocEntry{Ringraziamenti}}
\input{materiale_iniziale_finale/ringraziamenti}
