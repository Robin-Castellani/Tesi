...
\begin{figure}
	\centering
	\input{graphics/plots/electromagnetic_radiation}
...
\begin{table}[p]
	...
	\begin{tabular}{c c S[table-format=2.2]}
		\toprule
		Data		&	Tipo		&	\multicolumn{1}{c}{Risoluzione \si{[\m]}}	\\
		\midrule	
		2000-09-17		&	\AST{}		&	15	\\
		2001-06-07		&	\AST{}		&	15	\\
		2002-05-18		&	\AST{}		&	15	\\
...
Nel secondo grafico sono riportati solamente i livelli medi giornalieri maggiori di~\SI{2}{\m}: da questa soglia si assiste ad una completa connessione di pozze, canali e sorgenti tramite l'inondazione delle barre in ghiaia più alte, iniziando quindi ad esercitare effetti di disturbo sulla vegetazione \squarecite{Bertoldi:2009-2m}.
